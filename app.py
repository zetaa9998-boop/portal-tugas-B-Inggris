...
role = st.sidebar.selectbox("Login Sebagai:", ["Siswa", "Guru"], key="login_role_main")

# Filter Kelas
list_kelas = ["Semua Kelas"] + list(st.session_state.data_siswa["Kelas"].unique())
kelas_terpilih = st.sidebar.selectbox("Filter Kelas:", list_kelas,key="filter_kelas_sidebar")
